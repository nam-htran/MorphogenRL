...
def main(args: argparse.Namespace) -> Optional[str]:
    ...
    if use_tune:
        ...
        # START CHANGE: Sử dụng try...finally để đảm bảo algo.stop() được gọi
        algo = None
        ...
        try:
            ...
            # Luôn gọi stop() để dọn dẹp các worker một cách an toàn
            if algo:
                algo.stop()
                print("RLlib algorithm stopped gracefully.")
        # END CHANGE
